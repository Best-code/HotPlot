...
read:function(t,e,i,r,n){var s,o,a=8*n-r-1,u=(1<<a)-1,h=u>>1,f=-7,c=i?n-1:0,l=i?-1:1,d=t[e+c];for(c+=l,s=d&(1<<-f)-1,d>>=-f,f+=a;f>0;s=256*s+t[e+c],c+=l,f-=8);for(o=s&(1<<-f)-1,s>>=-f,f+=r;f>0;o=256*o+t[e+c],c+=l,f-=8);if(0===s)s=1-h;else{if(s===u)return o?NaN:1/0*(d?-1:1);o+=Math.pow(2,r),s-=h}return(d?-1:1)*o*Math.pow(2,s-r)},write:function(t,e,i,r,n,s){var o,a,u,h=8*s-n-1,f=(1<<h)-1,c=f>>1,l=23===n?Math.pow(2,-24)-Math.pow(2,-77):0,d=r?0:s-1,p=r?1:-1,y=e<0||0===e&&1/e<0?1:0;for(e=Math.abs(e),isNaN(e)||e===1/0?(a=isNaN(e)?1:0,o=f):(o=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-o))<1&&(o--,u*=2),(e+=o+c>=1?l/u:l*Math.pow(2,1-c))*u>=2&&(o++,u/=2),o+c>=f?(a=0,o=f):o+c>=1?(a=(e*u-1)*Math.pow(2,n),o+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,n),o=0));n>=8;t[i+d]=255&a,d+=p,a/=256,n-=8);for(o=o<<n|a,h+=n;h>0;t[i+d]=255&o,d+=p,o/=256,h-=8);t[i+d-p]|=128*y}},j=U,R=C;function U(t){this.buf=ArrayBuffer.isView&&ArrayBuffer.isView(t)?t:new Uint8Array(t||0),this.pos=0,this.type=0,this.length=this.buf.length}U.Varint=0,U.Fixed64=1,U.Bytes=2,U.Fixed32=5;var Z=4294967296,G=1/Z,$="undefined"==typeof TextDecoder?null:new TextDecoder("utf8");function q(t){return t.type===U.Bytes?t.readVarint()+t.pos:t.pos+1}function I(t,e,i){return i?4294967296*e+(t>>>0):4294967296*(e>>>0)+(t>>>0)}function W(t,e,i){var r=e<=16383?1:e<=2097151?2:e<=268435455?3:Math.floor(Math.log(e)/(7*Math.LN2));i.realloc(r);for(var n=i.pos-1;n>=t;n--)i.buf[n+r]=i.buf[n]}function J(t,e){for(var i=0;i<t.length;i++)e.writeVarint(t[i])}function H(t,e){for(var i=0;i<t.length;i++)e.writeSVarint(t[i])}function K(t,e){for(var i=0;i<t.length;i++)e.writeFloat(t[i])}function Q(t,e){for(var i=0;i<t.length;i++)e.writeDouble(t[i])}function X(t,e){for(var i=0;i<t.length;i++)e.writeBoolean(t[i])}function Y(t,e){for(var i=0;i<t.length;i++)e.writeFixed32(t[i])}function tt(t,e){for(var i=0;i<t.length;i++)e.writeSFixed32(t[i])}function et(t,e){for(var i=0;i<t.length;i++)e.writeFixed64(t[i])}function it(t,e){for(var i=0;i<t.length;i++)e.writeSFixed64(t[i])}function rt(t,e){return(t[e]|t[e+1]<<8|t[e+2]<<16)+16777216*t[e+3]}function nt(t,e,i){t[i]=e,t[i+1]=e>>>8,t[i+2]=e>>>16,t[i+3]=e>>>24}function st(t,e){return(t[e]|t[e+1]<<8|t[e+2]<<16)+(t[e+3]<<24)}U.prototype={destroy:function(){this.buf=null},readFields:function(t,e,i){for(i=i||this.length;this.pos<i;){var r=this.readVarint(),n=r>>3,s=this.pos;this.type=7&r,t(n,e,this),this.pos===s&&this.skip(r)}return e},readMessage:function(t,e){return this.readFields(t,e,this.readVarint()+this.pos)},readFixed32:function(){var t=rt(this.buf,this.pos);return this.pos+=4,t},readSFixed32:function(){var t=st(this.buf,this.pos);return this.pos+=4,t},readFixed64:function(){var t=rt(this.buf,this.pos)+rt(this.buf,this.pos+4)*Z;return this.pos+=8,t},readSFixed64:function(){var t=rt(this.buf,this.pos)+st(this.buf,this.pos+4)*Z;return this.pos+=8,t},readFloat:function(){var t=R.read(this.buf,this.pos,!0,23,4);return this.pos+=4,t},readDouble:function(){var t=R.read(this.buf,this.pos,!0,52,8);return this.pos+=8,t},readVarint:function(t){var e,i,r=this.buf;return e=127&(i=r[this.pos++]),i<128?e:(e|=(127&(i=r[this.pos++]))<<7,i<128?e:(e|=(127&(i=r[this.pos++]))<<14,i<128?e:(e|=(127&(i=r[this.pos++]))<<21,i<128?e:function(t,e,i){var r,n,s=i.buf;if(n=s[i.pos++],r=(112&n)>>4,n<128)return I(t,r,e);if(n=s[i.pos++],r|=(127&n)<<3,n<128)return I(t,r,e);if(n=s[i.pos++],r|=(127&n)<<10,n<128)return I(t,r,e);if(n=s[i.pos++],r|=(127&n)<<17,n<128)return I(t,r,e);if(n=s[i.pos++],r|=(127&n)<<24,n<128)return I(t,r,e);if(n=s[i.pos++],r|=(1&n)<<31,n<128)return I(t,r,e);throw new Error("Expected varint not more than 10 bytes")}(e|=(15&(i=r[this.pos]))<<28,t,this))))},readVarint64:function(){return this.readVarint(!0)},readSVarint:function(){var t=this.readVarint();return t%2==1?(t+1)/-2:t/2},readBoolean:function(){return Boolean(this.readVarint())},readString:function(){var t=this.readVarint()+this.pos,e=this.pos;return this.pos=t,t-e>=12&&$?function(t,e,i){return $.decode(t.subarray(e,i))}(this.buf,e,t):function(t,e,i){var r="",n=e;for(;n<i;){var s,o,a,u=t[n],h=null,f=u>239?4:u>223?3:u>191?2:1;if(n+f>i)break;1===f?u<128&&(h=u):2===f?128==(192&(s=t[n+1]))&&(h=(31&u)<<6|63&s)<=127&&(h=null):3===f?(s=t[n+1],o=t[n+2],128==(192&s)&&128==(192&o)&&((h=(15&u)<<12|(63&s)<<6|63&o)<=2047||h>=55296&&h<=57343)&&(h=null)):4===f&&(s=t[n+1],o=t[n+2],a=t[n+3],128==(192&s)&&128==(192&o)&&128==(192&a)&&((h=(15&u)<<18|(63&s)<<12|(63&o)<<6|63&a)<=65535||h>=1114112)&&(h=null)),null===h?(h=65533,f=1):h>65535&&(h-=65536,r+=String.fromCharCode(h>>>10&1023|55296),h=56320|1023&h),r+=String.fromCharCode(h),n+=f}return r}(this.buf,e,t)},readBytes:function(){var t=this.readVarint()+this.pos,e=this.buf.subarray(this.pos,t);return this.pos=t,e},readPackedVarint:function(t,e){if(this.type!==U.Bytes)return t.push(this.readVarint(e));var i=q(this);for(t=t||[];this.pos<i;)t.push(this.readVarint(e));return t},readPackedSVarint:function(t){if(this.type!==U.Bytes)return t.push(this.readSVarint());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readSVarint());return t},readPackedBoolean:function(t){if(this.type!==U.Bytes)return t.push(this.readBoolean());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readBoolean());return t},readPackedFloat:function(t){if(this.type!==U.Bytes)return t.push(this.readFloat());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readFloat());return t},readPackedDouble:function(t){if(this.type!==U.Bytes)return t.push(this.readDouble());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readDouble());return t},readPackedFixed32:function(t){if(this.type!==U.Bytes)return t.push(this.readFixed32());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readFixed32());return t},readPackedSFixed32:function(t){if(this.type!==U.Bytes)return t.push(this.readSFixed32());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readSFixed32());return t},readPackedFixed64:function(t){if(this.type!==U.Bytes)return t.push(this.readFixed64());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readFixed64());return t},readPackedSFixed64:function(t){if(this.type!==U.Bytes)return t.push(this.readSFixed64());var e=q(this);for(t=t||[];this.pos<e;)t.push(this.readSFixed64());return t},skip:function(t){var e=7&t;if(e===U.Varint)for(;this.buf[this.pos++]>127;);else if(e===U.Bytes)this.pos=this.readVarint()+this.pos;else if(e===U.Fixed32)this.pos+=4;else{if(e!==U.Fixed64)throw new Error("Unimplemented type: "+e);this.pos+=8}},writeTag:function(t,e){this.writeVarint(t<<3|e)},realloc:function(t){for(var e=this.length||16;e<this.pos+t;)e*=2;if(e!==this.length){var i=new Uint8Array(e);i.set(this.buf),this.buf=i,this.length=e}},finish:function(){return this.length=this.pos,this.pos=0,this.buf.subarray(0,this.length)},writeFixed32:function(t){this.realloc(4),nt(this.buf,t,this.pos),this.pos+=4},writeSFixed32:function(t){this.realloc(4),nt(this.buf,t,this.pos),this.pos+=4},writeFixed64:function(t){this.realloc(8),nt(this.buf,-1&t,this.pos),nt(this.buf,Math.floor(t*G),this.pos+4),this.pos+=8},writeSFixed64:function(t){this.realloc(8),nt(this.buf,-1&t,this.pos),nt(this.buf,Math.floor(t*G),this.pos+4),this.pos+=8},writeVarint:function(t){(t=+t||0)>268435455||t<0?function(t,e){var i,r;t>=0?(i=t%4294967296|0,r=t/4294967296|0):(r=~(-t/4294967296),4294967295^(i=~(-t%4294967296))?i=i+1|0:(i=0,r=r+1|0));if(t>=0x10000000000000000||t<-0x10000000000000000)throw new Error("Given varint doesn't fit into 10 bytes");e.realloc(10),function(t,e,i){i.buf[i.pos++]=127&t|128,t>>>=7,i.buf[i.pos++]=127&t|128,t>>>=7,i.buf[i.pos++]=127&t|128,t>>>=7,i.buf[i.pos++]=127&t|128,t>>>=7,i.buf[i.pos]=127&t}(i,0,e),function(t,e){var i=(7&t)<<4;if(e.buf[e.pos++]|=i|((t>>>=3)?128:0),!t)return;if(e.buf[e.pos++]=127&t|((t>>>=7)?128:0),!t)return;if(e.buf[e.pos++]=127&t|((t>>>=7)?128:0),!t)return;if(e.buf[e.pos++]=127&t|((t>>>=7)?128:0),!t)return;if(e.buf[e.pos++]=127&t|((t>>>=7)?128:0),!t)return;e.buf[e.pos++]=127&t}(r,e)}(t,this):(this.realloc(4),this.buf[this.pos++]=127&t|(t>127?128:0),t<=127||(this.buf[this.pos++]=127&(t>>>=7)|(t>127?128:0),t<=127||(this.buf[this.pos++]=127&(t>>>=7)|(t>127?128:0),t<=127||(this.buf[this.pos++]=t>>>7&127))))},writeSVarint:function(t){this.writeVarint(t<0?2*-t-1:2*t)},writeBoolean:function(t){this.writeVarint(Boolean(t))},writeString:function(t){t=String(t),this.realloc(4*t.length),this.pos++;var e=this.pos;this.pos=function(t,e,i){for(var r,n,s=0;s<e.length;s++){if((r=e.charCodeAt(s))>55295&&r<57344){if(!n){r>56319||s+1===e.length?(t[i++]=239,t[i++]=191,t[i++]=189):n=r;continue}if(r<56320){t[i++]=239,t[i++]=191,t[i++]=189,n=r;continue}r=n-55296<<10|r-56320|65536,n=null}else n&&(t[i++]=239,t[i++]=191,t[i++]=189,n=null);r<128?t[i++]=r:(r<2048?t[i++]=r>>6|192:(r<65536?t[i++]=r>>12|224:(t[i++]=r>>18|240,t[i++]=r>>12&63|128),t[i++]=r>>6&63|128),t[i++]=63&r|128)}return i}(this.buf,t,this.pos);var i=this.pos-e;i>=128&&W(e,i,this),this.pos=e-1,this.writeVarint(i),this.pos+=i},writeFloat:function(t){this.realloc(4),R.write(this.buf,t,this.pos,!0,23,4),this.pos+=4},writeDouble:function(t){this.realloc(8),R.write(this.buf,t,this.pos,!0,52,8),this.pos+=8},writeBytes:function(t){var e=t.length;this.writeVarint(e),this.realloc(e);for(var i=0;i<e;i++)this.buf[this.pos++]=t[i]},writeRawMessage:function(t,e){this.pos++;var i=this.pos;t(e,this);var r=this.pos-i;r>=128&&W(i,r,this),this.pos=i-1,this.writeVarint(r),this.pos+=r},writeMessage:function(t,e,i){this.writeTag(t,U.Bytes),this.writeRawMessage(e,i)},writePackedVarint:function(t,e){e.length&&this.writeMessage(t,J,e)},writePackedSVarint:function(t,e){e.length&&this.writeMessage(t,H,e)},writePackedBoolean:function(t,e){e.length&&this.writeMessage(t,X,e)},writePackedFloat:function(t,e){e.length&&this.writeMessage(t,K,e)},writePackedDouble:function(t,e){e.length&&this.writeMessage(t,Q,e)},writePackedFixed32:function(t,e){e.length&&this.writeMessage(t,Y,e)},writePackedSFixed32:function(t,e){e.length&&this.writeMessage(t,tt,e)},writePackedFixed64:function(t,e){e.length&&this.writeMessage(t,et,e)},writePackedSFixed64:function(t,e){e.length&&this.writeMessage(t,it,e)},writeBytesField:function(t,e){this.writeTag(t,U.Bytes),this.writeBytes(e)},writeFixed32Field:function(t,e){this.writeTag(t,U.Fixed32),this.writeFixed32(e)},writeSFixed32Field:function(t,e){this.writeTag(t,U.Fixed32),this.writeSFixed32(e)},writeFixed64Field:function(t,e){this.writeTag(t,U.Fixed64),this.writeFixed64(e)},writeSFixed64Field:function(t,e){this.writeTag(t,U.Fixed64),this.writeSFixed64(e)},writeVarintField:function(t,e){this.writeTag(t,U.Varint),this.writeVarint(e)},writeSVarintField:function(t,e){this.writeTag(t,U.Varint),this.writeSVarint(e)},writeStringField:function(t,e){this.writeTag(t,U.Bytes),this.writeString(e)},writeFloatField:function(t,e){this.writeTag(t,U.Fixed32),this.writeFloat(e)},writeDoubleField:function(t,e){this.writeTag(t,U.Fixed64),this.writeDouble(e)},writeBooleanField:function(t,e){this.writeVarintField(t,Boolean(e))}};var ot=d(j);function at(t,e,i){console.log(i);const r=t+`?${new URLSearchParams(i)}`;return console.log(r),fetch(r,e).then((function(e){if(e.ok)return e.arrayBuffer();if(404!==e.status)throw function(...t){return new Error(t.join(": "))}(t,e.status,e.statusText)}))}function ut(t){return`${t.x}|${t.y}|${t.z}`}const ht={featureToLayer:N,filter:void 0,layerOrder:void 0,layers:void 0,minZoom:0,maxZoom:18,maxDetailZoom:void 0,minDetailZoom:void 0,subdomains:"abc",zoomOffset:0,zoomReverse:!1};var ft=Object.freeze((function(t,e){const i=new h(e),r=Object.getPrototypeOf(i),n={};console.log("hi"),"string"==typeof(e=f.extend({},ht,e)).subdomains&&(e.subdomains=e.subdomains.split("")),e.vectorTileLayerStyles&&!e.style&&(e.style=function(t,i,r){const{getFeatureId:s,vectorTileLayerStyles:o}=e;let a=o[i];if(s){const e=s(t);n[e]&&(a=n[e])}if("function"==typeof a&&(a=a(t.properties,r,t.type)),Array.isArray(a)){if(!a.length)return;a=a[0]}return a});const s={};let o;function a(t){const i=Math.abs(t.x+t.y)%e.subdomains.length;return e.subdomains[i]}function u(t){const{minDetailZoom:i,maxDetailZoom:r}=e;return void 0!==i&&t<i?i:void 0!==r&&r<t?r:t}function d(t){const{maxZoom:i,zoomReverse:r,zoomOffset:n}=e;return r&&(t=i-t),u(t+n)}function p(t){Object.keys(s).forEach((e=>s[e].eachFeatureLayer(t)))}return i.on("tileunload",(function(t){const e=ut(t.coords),r=s[e];r&&(r.eachFeatureLayer(i.removeFeatureLayer),delete s[e])})),i.onAdd=function(t,...e){return o=t,r.onAdd.call(i,t,...e)},i.onRemove=function(...t){return o=void 0,r.onRemove.call(i,...t)},i.createTile=function(t,r){const n=ut(t),o=l(t,i);s[n]=o;const a=i.getTileUrl(t);console.log(a);const u=e.fetchOptions,h=a.data;return at(a.url,u,h).then((function(t){o.addVectorTile(new B(new ot(t))),r(null,o)}),(function(t){r(t,o)})),o.domElement()},i.getTileUrl=function(e){const r={s:a(e),x:e.x,y:e.y,z:d(e.z)};return o.options.crs.infinite||(r["-y"]=i._globalTileRange.max.y-e.y),console.log(t),{url:t,data:r}},i.setStyle=function(t){return e.style=t,p((function(t,e,r,n){const{feature:s,layerName:o}=t,a=i.getFeatureStyle(s,o,n.coords().z);t.setStyle(a)})),i},i.setFeatureStyle=function(t,r){return n[t]=r,i.setStyle(e.style),i},i.resetFeatureStyle=function(t){return delete n[t],i.setStyle(e.style),i},i.getTileSize=function(){const t=r.getTileSize.call(i),e=i._tileZoom;return void 0===e?t:t.divideBy(o.getZoomScale(u(e),e)).round()},i.getFeatureStyle=function(t,i,r){if(e.filter&&!e.filter(t,i,r))return;const n=e.style;return"function"==typeof n?n(t,i,r):n},i.getOrderedLayers=function(t,i){t=e.layers||t;const r=e.layerOrder;return void 0!==r?r(t,i):t},i.featureToLayer=e.featureToLayer,i.addFeatureLayer=function(t){return t.addTo(o),t.addEventParent(i),i},i.removeFeatureLayer=function(t){return t.removeEventParent(i),t.removeFrom(o),i},i.getBounds=function(){let t;return p((function(e,i,r,n){const s=t=>o.unproject(n.global(t),n.coords().z),a=e.bbox(),u=c(s(a.min),s(a.max));t?t.extend(u):t=u})),t},i}));export{T as applyBasicStyle,L as applyImageStyle,O as applyPathStyle,ft as default,N as defaultFeatureLayer,z as featureCircleLayer,E as featureIconLayer,P as featureLayerBase,D as featurePathLayer};
